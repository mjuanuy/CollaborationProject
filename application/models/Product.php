...
class Product extends CI_Model {
	...
	public function read_stocks_by_id($id){
		...
		$sql = "SELECT SUM(stocks_qnty) as stockq FROM stock WHERE SupplyRequestStatus = 'approved' AND product_id='".$id."'";
	...
	public function quantity_by_order($id){
		...
		$sql="SELECT SUM(quantity) as totalq from order_details where product_id=".$id;
