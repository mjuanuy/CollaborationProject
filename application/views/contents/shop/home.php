		...
		<div class="container-fluid">
                <?php foreach ($latest_products as $latest) { ?>
                    <div class="panel-body well" style=" float:left;padding:20px;margin:10px;background-color:#DCDCDC;">
                        <a href="<?= base_url('Shop/details?product='.$latest->product_id)?>" ><img style="width:250px;height:250px" src="<?php echo base_url('uploads/'.$latest->file_name)?>" alt="" /></a>
 	...
 	<br>	
		<div class="container-fluid">
                <?php foreach ($products as $single_products) { ?>
                    <div class="panel-body well" style=" float:left;padding:20px;margin:10px;background-color:#DCDCDC;">
                        <a  href="<?= base_url('Shop/details?product='.$single_products->product_id)?>" ><img style="width:250px;height:250px" src="<?php echo base_url('uploads/'.$single_products->file_name)?>" alt="" /></a>
