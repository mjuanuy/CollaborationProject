...
CREATE TABLE `order_details` (
  ...
  `order_qnty` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `order_details` (`order_id`, `product_id`, `order_qnty`) VALUES
(5, 15, 1),
(5, 13, 1),
(5, 16, 3),
(6, 15, 1),
...
INSERT INTO `products` (`product_id`, `product_name`, `purchase_price`, `sell_price`, `prod_quantity`, `product_image`, `short_desc`, `description`, `category_id`, `supplier_id`, `date_added`) VALUES
(13, 'SAMSUNG GALAXY S10', 68000, 70000, 50, 'samsung.png', 'Galaxy S10 Brand New Smarthphone', 'Galaxy S10e, S10, and S10+ learn your daily routine and usage patterns, powering down apps you don\'t need. Also, Adaptive Power Saving Mode manages your battery life based on the prediction of your day', 1, 1, '2019-03-21 14:48:35'),
(14, 'ASUS-GX097', 86899, 92999, 55, 'zephyrus.png', 'I7 9TH GEN WITH RTX 2080Ti', 'I7 9TH GEN WITH RTX 2080Ti', 2, 1, '2019-03-21 14:48:35'),
(15, 'IPhone X', 45000, 49000, 45, 'iphone.png', 'iphone for everybody', 'IPhone para sa mga dato rani ayaw na mog palit patas.on lng nako ang description arun ingnun.', 1, 1, '2019-03-21 14:50:00'),
(16, 'Huawei Mate 10', 30000, 39000, 100, 'mate.png', 'Mate 10 that rivals Iphone Babies', 'Mate 10 that rivals Iphone Babies Mate 10 that rivals Iphone Babies Mate 10 that rivals Iphone Babies Mate 10 that rivals Iphone Babies', 1, 3, '2019-03-21 14:54:20'),
(17, 'Razer Blade 15', 90000, 119099, 35, 'razer.png', 'razer razer', ' this is razer this is razer this is razer this is razer this is razer this is razer this is razer this is razer ', 2, 3, '2019-03-27 17:02:56');
...
INSERT INTO `stock` (`stock_id`, `product_id`, `supplier_id`, `stocks_qnty`) VALUES
(2, 14, 2, 100),
(3, 16, 1, 4),
(4, 15, 2, 6),
(13, 13, 1, 3);
